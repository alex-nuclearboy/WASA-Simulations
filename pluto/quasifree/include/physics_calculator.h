...
public:
     ...
     */
    Double_t calculateEnergy(Double_t p, Double_t m);
     ...
     */
    Double_t calculateInvariantMass(Double_t m1, Double_t m2, Double_t p);
     ...
     */
    Double_t calculateEffectiveProtonMass(Double_t p);
     ...
     */
    Double_t calculateEffectiveProtonMomentum(
     ...
     */
    Double_t calculateBetaCM(Double_t p, Double_t m1, Double_t m2);
     ...
     */
    Double_t calculateGammaCM(Double_t beta);
     ...
     */
    TLorentzVector createFourVector(
