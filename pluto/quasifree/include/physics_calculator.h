...
public:
    ...
    Double_t calculateEffectiveProtonMass(Double_t target_proton_momentum);
    Double_t calculateEffectiveProtonMomentum(Double_t beam_proton_energy, Double_t target_proton_energy, Double_t beam_proton_momentum, Double_t target_proton_momentum, Double_t angle, Double_t effective_proton_mass);
